...
## 7. Advanced Effects (Pro)

TextureFXLayers provide animated texture effects for radar charts:

- **Stroke effects**: `RadarSettings.stroke.textureFXLayers`
  - UV animation (flowing outline effect)
  - Color animation (pulsing radar outline)

- **Area effects**: `RadarSettings.area.textureFXLayers`
  - Animated area fill
  - Color gradient animation

- **Point effects**: `RadarSettings.point.textureFXLayers`
  - Color animation (blinking points)

See [Texture FX Layers](./03_08-TextureFXLayers.md) for detailed configuration.
