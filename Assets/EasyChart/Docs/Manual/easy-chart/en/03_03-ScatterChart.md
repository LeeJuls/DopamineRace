...
TextureFXLayers provide animated texture effects for scatter points:

- **Point effects**: `ScatterSettings.point.textureFXLayers`
  - Color animation (pulsing/fading points)
  - UV animation (rotating textures)
