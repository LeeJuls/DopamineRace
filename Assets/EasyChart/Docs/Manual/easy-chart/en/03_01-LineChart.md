...
### 5.1 Advanced Effects (Pro)

TextureFXLayers provide animated texture effects:

- **Stroke effects**: `LineSettings.stroke.textureFXLayers`
  - UV animation (flowing line effect)
  - Color animation (pulsing/fading)
  
- **Point effects**: `LineSettings.point.textureFXLayers`
  - Color animation (blinking points)
  
- **Area effects**: `LineSettings.area.textureFXLayers`
  - Animated area fill
