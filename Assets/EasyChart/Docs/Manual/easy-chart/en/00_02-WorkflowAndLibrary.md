...
## 1. Why the UI Toolkit workflow is recommended
...
## 3. Recommended workflow (from configuration to page)
...
## 4. Folder layout recommendations for your chart library
...
## 7. Editor workflow & panels quick reference (Library Editor)
...
### 7.1 What are you editing? (ChartProfile)
...
### 7.2 Main areas of the Library Editor
...
### 8.2 Category axis: labels and LabelPlacement
...
### 8.3 Value axis: autoRangeMin / autoRangeMax
...
#### 8.3.1 Common template: Y axis starts at 0

- `axisType = Value`
- Fix `minValue = 0`
- `autoRangeMax = true`

#### 8.3.2 Common template: lock only Max (e.g. percentages)

- Fix `maxValue = 100`
- `autoRangeMin = true`

### 8.4 rounding / unit / labelFormat
...
## 9. Series and data (Serie / SeriesData)

### 9.1 Serie (one series)
...
### 9.3 Matching SerieType and coordinate system
...
### 9.4 Common data patterns (by type)
...
### 9.5 Common data pitfalls (symptom-driven)
