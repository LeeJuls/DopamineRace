...
## 8. Advanced Effects (Pro)

TextureFXLayers provide animated texture effects for bars:

- **Bar fill effects**: `BarSettings.textureFXLayers`
  - UV animation (flowing texture on bars)
  - Color animation (pulsing/fading bars)
