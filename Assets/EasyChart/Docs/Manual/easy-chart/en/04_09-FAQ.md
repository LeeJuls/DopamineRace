...
## 1. Fast troubleshooting path (30-second version)
...
## 2. I clicked Preview but nothing shows
...
## 3. Category axis has labels, but points/bars are not on labels
...
## 4. Value axis range is weird (too large/too small)
...
## 5. Line is broken / nothing renders
...
## 6. Bar chart and labels do not align
...
## 7. Heatmap is all one color / looks flat
...
## 8. Radar labels are missing/messy
...
## 9. tooltip/hover/selection points to the wrong item or state is unstable
...
## 10. I don't know which chapter to read
