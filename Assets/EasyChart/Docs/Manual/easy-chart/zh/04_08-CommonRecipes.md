...
## 4. 并列柱（Grouped Bar）：多条 Serie 共享同一套类目
...
## 5. 堆叠柱（Stacked Bar）：stacked + stackGroup
...
## 6. 散点图（Scatter）：Value X/Y + hover + sizeMapping
...
## 9. 交互/tooltip 稳定性：SeriesData.id
