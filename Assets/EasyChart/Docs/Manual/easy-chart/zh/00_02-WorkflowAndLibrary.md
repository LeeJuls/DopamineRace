...
### 8.2 Category 轴：labels 与 LabelPlacement
...
### 8.3 Value 轴：autoRangeMin / autoRangeMax
...
#### 8.3.1 常见模板：Y 轴从 0 开始

- `axisType = Value`
- 固定 `minValue = 0`
- `autoRangeMax = true`

#### 8.3.2 常见模板：只锁定 Max（例如百分比）
